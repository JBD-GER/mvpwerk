            ...
            <div className="sticky top-6">
              <div className="relative overflow-hidden rounded-[1.6rem] border border-slate-900/10 bg-white/70 p-5 shadow-sm backdrop-blur-xl">
                ...
                <div className="mt-4 text-[11px] text-slate-600">
                  Rechtliches: <Link className="font-medium text-slate-900 underline underline-offset-2" href="/impressum">Impressum</Link>
                </div>
                ...
                <div className="relative space-y-10">
                  <Section id="ueberblick" title="Überblick">
                    <div className="grid gap-3 sm:grid-cols-2">
                      <InfoRow
                        k="Verantwortlicher"
                        v={<span>{COMPANY.legal}</span>}
                      />
                      <InfoRow
                        k="Kontakt"
                        v={
                          <span>
                            <a className="underline underline-offset-2" href={`mailto:${COMPANY.email}`}>{COMPANY.email}</a>
                            {' '}·{' '}
                            <a className="underline underline-offset-2" href={`tel:${COMPANY.phone.replace(/\s/g, '')}`}>{COMPANY.phone}</a>
                          </span>
                        }
                      />
                      <InfoRow
                        k="Hosting"
                        v={<span>Vercel (Webhosting/Edge/Logs)</span>}
                      />
                      <InfoRow
                        k="App/DB/Auth"
                        v={<span>Supabase (DB, Auth, Storage)</span>}
                      />
                      <InfoRow
                        k="Tracking"
                        v={<span>Google Tag Manager &amp; Google Analytics (GA4)</span>}
                      />
                      <InfoRow
                        k="Einwilligung"
                        v={<span>Tracking i.d.R. nur nach Consent (Cookie/Consent-Banner)</span>}
                      />
                    </div>
                    ...
                    <div className="mt-4 rounded-2xl border border-slate-900/10 bg-white/70 p-4 text-[12px] leading-relaxed text-slate-700 shadow-sm">
                      ...
                      Wir nutzen Tracking/Conversion-Tracking grundsätzlich so, dass es erst nach Ihrer Einwilligung aktiviert wird
                      (sofern technisch eingerichtet). Ohne Einwilligung erfolgt nur technisch notwendige Verarbeitung (z. B. Server-Logs).
                    </div>
                  </Section>
                  ...
                  <Section id="verantwortlicher" title="1. Verantwortlicher">
                    <div className="rounded-2xl border border-slate-900/10 bg-white/70 p-4 shadow-sm">
                      ...
                      <div className="mt-1 text-[12px] text-slate-700">{COMPANY.street}, {COMPANY.zipCity}</div>
                      <div className="mt-2 grid gap-2 text-[12px] text-slate-700 sm:grid-cols-2">
                        <div>Geschäftsführer: <span className="font-medium text-slate-900">{COMPANY.managingDirector}</span></div>
                        <div>E-Mail: <a className="font-medium text-slate-900 underline underline-offset-2" href={`mailto:${COMPANY.email}`}>{COMPANY.email}</a></div>
                      </div>
                    </div>
                    <p>
                      Ein Datenschutzbeauftragter ist nicht bestellt, sofern dies nicht gesetzlich erforderlich ist.
                    </p>
                  </Section>

                  <Section id="datenarten" title="2. Datenarten & Zwecke">
                    <ul className="space-y-2">
                      <li>• <span className="font-semibold text-slate-900">Nutzungs-/Logdaten</span> (z. B. IP-Adresse, Zeitstempel, aufgerufene Seite) zur technischen Bereitstellung & Sicherheit.</li>
                      <li>• <span className="font-semibold text-slate-900">Kontakt-/Kommunikationsdaten</span> (z. B. Name, E-Mail, Nachricht) zur Bearbeitung von Anfragen.</li>
                      <li>• <span className="font-semibold text-slate-900">Analyse-/Marketingdaten</span> (z. B. Ereignisse/Conversions) zur Reichweitenmessung und Optimierung – i.d.R. nur nach Einwilligung.</li>
                      <li>• <span className="font-semibold text-slate-900">App-Daten</span> (bei Nutzung einer Demo/App) in Supabase (Auth/DB/Storage) je nach Funktionsumfang.</li>
                    </ul>
                  </Section>

                  <Section id="rechtsgrundlagen" title="3. Rechtsgrundlagen">
                    <ul className="space-y-2">
                      <li>• <span className="font-semibold text-slate-900">Art. 6 Abs. 1 lit. b DSGVO</span> – Vertragsdurchführung/Anbahnung (z. B. Projektanfrage).</li>
                      <li>• <span className="font-semibold text-slate-900">Art. 6 Abs. 1 lit. f DSGVO</span> – berechtigtes Interesse (Sicherheit, Stabilität, Missbrauchsprävention).</li>
                      <li>• <span className="font-semibold text-slate-900">Art. 6 Abs. 1 lit. a DSGVO</span> – Einwilligung (z. B. Analytics/Marketing/Conversion Tracking).</li>
                    </ul>
                  </Section>

                  <Section id="hosting" title="4. Hosting (Vercel) & Server-Logs">
                    <p>
                      Diese Website wird über Vercel bereitgestellt. Dabei werden zur Auslieferung und Absicherung der Website
                      technisch notwendige Daten verarbeitet (z. B. Server-Logs, IP-Adresse, User-Agent, Referrer, Zeitstempel).
                    </p>
                    <p>
                      Zweck: Bereitstellung der Website, Fehleranalyse, Abwehr von Angriffen (z. B. DDoS), Optimierung der Auslieferung.
                  ...
                  <Section id="supabase" title="5. Supabase (Auth/DB/Storage)">
                    <p>
                      Für App-Funktionen (z. B. Login/Accounts, Datenbank, Dateiablage) nutzen wir Supabase.
                      Dabei können je nach Nutzung u. a. Accountdaten (E-Mail), technische Metadaten sowie Inhalte/Daten in der Datenbank verarbeitet werden.
                    </p>
                    <p>
                  ...
                  <Section id="kontakt" title="6. Kontaktaufnahme">
                    <p>
                      Wenn Sie uns kontaktieren (z. B. per E-Mail, Telefon oder Kontaktformular), verarbeiten wir die von Ihnen übermittelten Daten
                      zur Bearbeitung der Anfrage und für Rückfragen.
                    </p>
                    <p>
                  ...
                  <Section id="cookies" title="7. Cookies & Einwilligung">
                    <p>
                      Wir verwenden – abhängig von Ihrer Auswahl im Consent-/Cookie-Banner – Cookies bzw. ähnliche Technologien.
                      Technisch notwendige Cookies können ohne Einwilligung gesetzt werden. Analyse/Marketing erfolgt in der Regel nur nach Einwilligung.
                    </p>
                  </Section>

                  <Section id="gtm" title="8. Google Tag Manager">
                    <p>
                      Wir nutzen den Google Tag Manager, um Website-Tags zentral zu verwalten. Der Tag Manager selbst erstellt in der Regel keine Nutzerprofile,
                      kann jedoch technisch bedingt Daten (z. B. IP-Adresse) übermitteln, um Tags auszuliefern.
                    </p>
                    <p>
                      Rechtsgrundlage: Art. 6 Abs. 1 lit. a DSGVO (Einwilligung) – sofern der Einsatz nicht als rein technisch notwendig konfiguriert ist.
                      Wir empfehlen, den Tag Manager über ein Consent-Management zu steuern.
                    </p>
                  </Section>

                  <Section id="ga" title="9. Google Analytics (GA4) & Conversion Tracking">
                    <p>
                      Wir verwenden Google Analytics (GA4), um die Nutzung unserer Website zu analysieren und Conversions zu messen (z. B. „Kontakt gesendet“).
                      Dabei werden Ereignisse (Events) erfasst und ausgewertet.
                    </p>
                    <p>
                      Rechtsgrundlage: Art. 6 Abs. 1 lit. a DSGVO (Einwilligung). Ohne Einwilligung wird Analytics/Conversion Tracking nicht oder nur in
                      einer entsprechend eingeschränkten Form ausgeführt (je nach technischer Konfiguration).
                    </p>
                    <ul className="space-y-2">
                  ...
                  <Section id="drittland" title="10. Drittlandübermittlung">
                    <p>
                      Bei der Nutzung von Diensten wie Google kann eine Verarbeitung von Daten in Drittländern (z. B. USA) nicht ausgeschlossen werden.
                      Wir stützen die Übermittlung auf geeignete Garantien (z. B. Standardvertragsklauseln und/oder anwendbare Zertifizierungsmechanismen),
                      soweit erforderlich.
                    </p>
                  </Section>
                  ...
                  <Section id="speicher" title="11. Speicherdauer">
                    <p>
                      ...
                      Kontaktanfragen werden regelmäßig gelöscht, sobald sie abschließend bearbeitet sind, sofern keine gesetzlichen Pflichten entgegenstehen.
                    </p>
                  </Section>
                  ...
                  <Section id="widerspruch" title="13. Widerspruch & Widerruf">
                    <p>
                      ...
                      Außerdem können Sie der Verarbeitung auf Grundlage berechtigter Interessen widersprechen, sofern Gründe aus Ihrer besonderen Situation vorliegen.
                    </p>
                    <p>
                  ...
                  <Section id="updates" title="14. Änderungen dieser Erklärung">
                    <p>
                      Wir behalten uns vor, diese Datenschutzerklärung anzupassen, wenn sich Rechtslage, Dienste oder Datenverarbeitung ändern.
                      Es gilt die jeweils aktuelle Fassung auf dieser Seite.
                    </p>
                  </Section>
