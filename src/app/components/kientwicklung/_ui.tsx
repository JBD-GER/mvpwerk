// src/app/components/kientwicklung/_ui.tsx
...
export function DividerSoft() {
  return <div className="my-10 h-px w-full bg-gradient-to-r from-transparent via-slate-900/10 to-transparent" />
}
...
export function IconBubble({ children }: { children: ReactNode }) {
  return (
    <div className="inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-white/60 bg-white/70 shadow-sm backdrop-blur">
      {children}
    </div>
  )
}
