// src/app/components/blockchainentwicklung/BlockchainHeroSection.tsx
...
export default function BlockchainHeroSection({ lang }: { lang: Lang }) {
  const t =
    lang === 'de'
      ? {
          eyebrow: 'Blockchain Entwicklung (Smart Contracts → Integrationen → Betrieb)',
          title: 'Blockchain, die Nutzen stiftet – nicht Buzzwords.',
          subtitle:
            'Wir bauen Blockchain-Komponenten für B2B: Smart Contracts, Tokenisierung, sichere Integrationen, Wallet-Flows und betriebsfähige Prozesse. Fokus: Security, Testbarkeit und reale Abläufe.',
          bullets: [
            'Smart Contracts: klare Regeln, Events, Upgradestrategie',
            'Integrationen: Backend, Indexing, Payments, Identity/Permissions',
            'Security: Reviews, Testing, Threat Modeling, Audit-Readiness',
            'Betrieb: Monitoring, Incident-Flow, Schlüssel- & Wallet-Prozesse',
          ],
          cta1: 'Projekt anfragen',
          cta2: 'Deliverables ansehen',
          trust1: 'Security-first',
          trust2: 'Audit-ready',
          trust3: 'Saubere Integrationen',
          trust4: 'B2B-Prozesse',
          rating: 'Top bewertet',
          from: 'für Plattformen & Token-Use-Cases',
        }
      : {
          eyebrow: 'Blockchain Development (smart contracts → integrations → ops)',
          title: 'Blockchain that delivers value – not buzzwords.',
          subtitle:
            'We build blockchain components for B2B: smart contracts, tokenization, secure integrations, wallet flows and operational processes. Focus: security, testability and real workflows.',
          bullets: [
            'Smart contracts: clear rules, events, upgrade strategy',
            'Integrations: backend, indexing, payments, identity/permissions',
            'Security: reviews, testing, threat modeling, audit readiness',
            'Operations: monitoring, incident flow, key & wallet processes',
          ],
          cta1: 'Request a project',
          cta2: 'View deliverables',
          trust1: 'Security-first',
          trust2: 'Audit-ready',
          trust3: 'Clean integrations',
          trust4: 'B2B workflows',
          rating: 'Top rated',
          from: 'for platforms & token use-cases',
        }

  return (
    <section className="relative overflow-hidden pt-10 sm:pt-14">
      {/* Background: hex + chain */}
        ...
        <div className="mt-10 grid gap-4 lg:grid-cols-2">
          ...
          <GlassCard className="p-6">
            ...
            <p className="mt-4 text-sm leading-relaxed text-slate-600">
              {lang === 'de'
                ? 'Blockchain scheitert selten an „Code schreiben“ – sondern an Security, Schlüsselprozessen, Integrationen und Betrieb. Genau das bauen wir von Anfang an mit.'
                : 'Blockchain rarely fails on “writing code” — it fails on security, key processes, integrations and operations. That’s what we design from day one.'}
            </p>
          </GlassCard>
        </div>
